...
public class RepositorioCliente implements IRepositorio, Serializable{
	...
	private static RepositorioCliente abrirArquivo() throws IOException {
	...
	private int procurarIndice(String nome){
		...
		while ((!achou) && (i < this.proxima)) {
			if (nome.equals(this.clientes[i].getNome())) {
